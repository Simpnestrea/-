        ...
        <div class="w-full max-w-md mx-auto mt-12 md:mt-0">
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="login_id" value="{{ old('login_id') }}" class="w-full px-4 py-3 rounded-lg border @error('login_id') border-red-500 @else border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 @enderror outline-none transition" placeholder="Ví dụ: you@example.com hoặc your_username" required>
                    @error('login_id')
            ...
            <div class="mt-8 text-center text-sm text-gray-600">
                ...
                <a href="{{ route('register') }}" class="text-orange-500 font-bold hover:underline">Tạo tài khoản mới</a>
            </div>
        </div>
    </div>

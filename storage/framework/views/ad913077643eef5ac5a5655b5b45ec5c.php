<?php $__env->startSection('title', 'Quản lý Danh mục - Foodball'); ?>
<?php $__env->startSection('page_title', 'Quản lý Danh mục'); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6" x-data="{ 
    ...
    hasNoVisibleCategories() {
        ...
        const names = [
            ...
            this.removeAccents('<?php echo e(addslashes($category->name)); ?>'),
    ...
    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm h-fit">
        ...
        <form action="<?php echo e(route('admin.categories.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr x-show="!searchQuery || removeAccents('<?php echo e(addslashes($category->name)); ?>').includes(removeAccents(searchQuery))" 
                            class="hover:bg-slate-50/30 transition-all">
                            
                            <!-- Image -->
                            <td class="px-6 py-4 whitespace-nowrap">
                                <img src="<?php echo e($category->image ?? 'https://images.unsplash.com/photo-1495521821757-a1efb6729352?w=120'); ?>" 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center font-bold text-slate-705 font-mono">
                                <?php echo e($category->recipes_count); ?> món
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <!-- Edit Trigger Button -->
                                    <button @click="openEditModal({ id: <?php echo e($category->id); ?>, name: '<?php echo e(addslashes($category->name)); ?>', image: '<?php echo e($category->image); ?>' })" 
                                        class="bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold px-3 py-1.5 rounded-lg text-xs transition">
                                        Chỉnh sửa
                                    </button>

                                    <!-- Delete Category Form -->
                                    <form action="<?php echo e(route('admin.categories.delete', $category)); ?>" method="POST" class="m-0 inline"
                                        onsubmit="return confirm('Bạn có chắc chắn muốn xóa danh mục \"<?php echo e($category->name); ?>\"? Tất cả công thức thuộc danh mục này sẽ chuyển về trạng thái Chưa phân loại.')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\--main\resources\views/admin/categories.blade.php ENDPATH**/ ?>
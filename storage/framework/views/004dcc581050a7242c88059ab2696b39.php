        ...
        <div class="w-full max-w-md mx-auto mt-12 py-8">
            ...
            <form action="<?php echo e(route('register.post')); ?>" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="w-full px-4 py-3 rounded-lg border <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?> outline-none transition" placeholder="Ví dụ: Đầu bếp tại gia" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="username" value="<?php echo e(old('username')); ?>" class="w-full px-4 py-3 rounded-lg border <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> outline-none transition" placeholder="Ví dụ: daubep123" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full px-4 py-3 rounded-lg border <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> outline-none transition" placeholder="you@example.com" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="password" name="password" class="w-full px-4 py-3 rounded-lg border <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> outline-none transition" placeholder="Tạo mật khẩu (ít nhất 8 ký tự)" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-8 text-center text-sm text-gray-600">
                Đã có tài khoản? 
                <a href="<?php echo e(route('login')); ?>" class="text-orange-500 font-bold hover:underline">Đăng nhập ngay</a>
            </div>
        </div>
    </div>

</body>
</html><?php /**PATH E:\--main\resources\views/register.blade.php ENDPATH**/ ?>
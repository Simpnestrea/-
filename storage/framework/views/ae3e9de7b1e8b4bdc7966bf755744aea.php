...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard - Foodball'); ?></title>
...
<body class="bg-slate-50 text-slate-800 flex h-screen overflow-hidden">
    ...
    <aside class="w-64 border-r border-slate-800 flex flex-col flex-shrink-0 bg-[#0F172A] text-white z-20 shadow-2xl relative">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="p-6 flex items-center space-x-3 group block border-b border-slate-800/80">
        ...
        <nav class="flex-1 overflow-y-auto custom-scrollbar px-4 py-6 space-y-1.5">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/20 font-bold' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4zM14 16a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2v-4z"></path></svg>
                <span>Tổng quan</span>
            </a>

            <a href="<?php echo e(route('admin.users')); ?>" class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.users') ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/20 font-bold' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                <span>Thành viên</span>
            </a>

            <a href="<?php echo e(route('admin.recipes')); ?>" class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.recipes') ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/20 font-bold' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                <span>Công thức món ăn</span>
            </a>

            <a href="<?php echo e(route('admin.categories')); ?>" class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.categories') ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/20 font-bold' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                <span>Danh mục</span>
            </a>

            <a href="<?php echo e(route('admin.reports')); ?>" class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.reports') ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/20 font-bold' : 'text-slate-400 hover:bg-slate-800/50 hover:text-white'); ?>">
                <div class="flex-1 flex items-center justify-between">
                    ...
                    <?php if($pendingReportsCount > 0): ?>
                        <span class="bg-red-500 text-white text-[10px] font-black px-2 py-0.5 rounded-full animate-bounce"><?php echo e($pendingReportsCount); ?></span>
                    <?php endif; ?>
                </div>
            </a>

            <div class="pt-6 border-t border-slate-800/60 my-4">
                <a href="<?php echo e(route('home')); ?>" class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl font-semibold text-slate-400 hover:bg-slate-800/50 hover:text-white transition-all">
        ...
        <div class="p-4 border-t border-slate-800 bg-[#0B0F19] flex items-center justify-between">
            <div class="flex items-center space-x-3 overflow-hidden">
                ...
                <div class="overflow-hidden">
                    <p class="font-bold text-sm truncate text-white leading-tight"><?php echo e(auth()->user()->name); ?></p>
    ...
    <main class="flex-1 flex flex-col overflow-y-auto bg-slate-50 relative">
        ...
        <header class="flex items-center justify-between px-8 py-4.5 sticky top-0 glass-header z-10 border-b border-slate-200/80 shrink-0 shadow-sm">
            <div>
                <h1 class="text-lg font-extrabold text-slate-900 tracking-tight"><?php echo $__env->yieldContent('page_title', 'Admin Dashboard'); ?></h1>
        ...
        <?php if(session('success')): ?>
            <div x-data x-init="window.dispatchEvent(new CustomEvent('toast', { detail: { message: '<?php echo e(addslashes(session('success'))); ?>', type: 'success' } }))"></div>
        <?php endif; ?>

        <?php if(session('error')): ?>
            <div x-data x-init="window.dispatchEvent(new CustomEvent('toast', { detail: { message: '<?php echo e(addslashes(session('error'))); ?>', type: 'error' } }))"></div>
        <?php endif; ?>
...
<?php /**PATH E:\--main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>